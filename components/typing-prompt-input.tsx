...
export default function TypingPromptInput() {
  const prompts = [
    "Help me prepare for NID entrance exam with practice questions...",
    "Show me advanced digital painting techniques for character design...",
    "Create a study plan for NIFT fashion design entrance exam...",
    "Teach me color theory fundamentals for my art portfolio...",
    "Guide me through UI/UX design principles for beginners...",
  ]
