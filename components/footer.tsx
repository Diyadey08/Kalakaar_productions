    ...
    <footer className="border-t py-12 md:py-16">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <nav aria-label="Resources Navigation">
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/portfolio-tips" className="text-muted-foreground hover:text-foreground">
                    Portfolio Tips
                  </Link>
                </li>
                <li>
                  <Link href="/exam-prep" className="text-muted-foreground hover:text-foreground">
                    Exam Preparation
                  </Link>
                </li>
                <li>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">© {currentYear} Kalakaar. All rights reserved.</p>
